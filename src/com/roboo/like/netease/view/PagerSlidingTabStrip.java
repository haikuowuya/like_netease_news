...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0x001177FF;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		tabsContainer = (LinearLayout) view.findViewById(R.id.linear_tabs_container);
		tabsContainer.setOrientation(LinearLayout.HORIZONTAL);
		//tabsContainer.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f));
		addView(view);
		//default 
