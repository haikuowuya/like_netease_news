...
public class MyViewPager extends ViewPager {
	...
	public MyViewPager(Context context, AttributeSet attrs) {
		...
		setFadeEnabled(ta.getBoolean(R.styleable.MyViewPager_fadeEnable, false));
		setOutlineEnabled(ta.getBoolean(R.styleable.MyViewPager_outlineEnabled, false));
		setOutlineColor(ta.getColor(R.styleable.MyViewPager_outlineColor, Color.WHITE));
		switch (mEffect) {
		case Stack:
		case ZoomOut:
			setFadeEnabled(true);
